 ...
 * @final
 */
class DependencyInjectionContainer_a8b8a1d73bfb2cefd035c8c662d67f40b15203c1 extends Container
{
    private $parameters = [];
    private $getService;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'Dmind\\Cookieman\\DataProcessing\\TypoScriptSettingsProcessor' => 'getTypoScriptSettingsProcessorService',
            ...
            'backend.routes_decorated_27' => 'getBackend_RoutesDecorated27Service',
            ...
            'middlewares_decorated_26' => 'getMiddlewaresDecorated26Service',
        ...
        $this->aliases = [
            ...
            'backend.routes' => 'backend.routes_decorated_27',
            'backend.routes_decorated_1' => 'backend.routes_decorated_27',
            'backend.routes_decorated_10' => 'backend.routes_decorated_27',
            'backend.routes_decorated_11' => 'backend.routes_decorated_27',
            'backend.routes_decorated_12' => 'backend.routes_decorated_27',
            'backend.routes_decorated_13' => 'backend.routes_decorated_27',
            'backend.routes_decorated_14' => 'backend.routes_decorated_27',
            'backend.routes_decorated_15' => 'backend.routes_decorated_27',
            'backend.routes_decorated_16' => 'backend.routes_decorated_27',
            'backend.routes_decorated_17' => 'backend.routes_decorated_27',
            'backend.routes_decorated_18' => 'backend.routes_decorated_27',
            'backend.routes_decorated_19' => 'backend.routes_decorated_27',
            'backend.routes_decorated_2' => 'backend.routes_decorated_27',
            'backend.routes_decorated_20' => 'backend.routes_decorated_27',
            'backend.routes_decorated_21' => 'backend.routes_decorated_27',
            'backend.routes_decorated_22' => 'backend.routes_decorated_27',
            'backend.routes_decorated_23' => 'backend.routes_decorated_27',
            'backend.routes_decorated_24' => 'backend.routes_decorated_27',
            'backend.routes_decorated_25' => 'backend.routes_decorated_27',
            'backend.routes_decorated_26' => 'backend.routes_decorated_27',
            'backend.routes_decorated_3' => 'backend.routes_decorated_27',
            'backend.routes_decorated_4' => 'backend.routes_decorated_27',
            'backend.routes_decorated_5' => 'backend.routes_decorated_27',
            'backend.routes_decorated_6' => 'backend.routes_decorated_27',
            'backend.routes_decorated_7' => 'backend.routes_decorated_27',
            'backend.routes_decorated_8' => 'backend.routes_decorated_27',
            'backend.routes_decorated_9' => 'backend.routes_decorated_27',
            ...
            'middlewares' => 'middlewares_decorated_26',
            'middlewares_decorated_1' => 'middlewares_decorated_26',
            'middlewares_decorated_10' => 'middlewares_decorated_26',
            'middlewares_decorated_11' => 'middlewares_decorated_26',
            'middlewares_decorated_12' => 'middlewares_decorated_26',
            'middlewares_decorated_13' => 'middlewares_decorated_26',
            'middlewares_decorated_14' => 'middlewares_decorated_26',
            'middlewares_decorated_15' => 'middlewares_decorated_26',
            'middlewares_decorated_16' => 'middlewares_decorated_26',
            'middlewares_decorated_17' => 'middlewares_decorated_26',
            'middlewares_decorated_18' => 'middlewares_decorated_26',
            'middlewares_decorated_19' => 'middlewares_decorated_26',
            'middlewares_decorated_2' => 'middlewares_decorated_26',
            'middlewares_decorated_20' => 'middlewares_decorated_26',
            'middlewares_decorated_21' => 'middlewares_decorated_26',
            'middlewares_decorated_22' => 'middlewares_decorated_26',
            'middlewares_decorated_23' => 'middlewares_decorated_26',
            'middlewares_decorated_24' => 'middlewares_decorated_26',
            'middlewares_decorated_25' => 'middlewares_decorated_26',
            'middlewares_decorated_3' => 'middlewares_decorated_26',
            'middlewares_decorated_4' => 'middlewares_decorated_26',
            'middlewares_decorated_5' => 'middlewares_decorated_26',
            'middlewares_decorated_6' => 'middlewares_decorated_26',
            'middlewares_decorated_7' => 'middlewares_decorated_26',
            'middlewares_decorated_8' => 'middlewares_decorated_26',
            'middlewares_decorated_9' => 'middlewares_decorated_26',
        ];
    }
    ...
    /**
     * Gets the public 'Dmind\Cookieman\DataProcessing\TypoScriptSettingsProcessor' shared autowired service.
     *
     * @return \Dmind\Cookieman\DataProcessing\TypoScriptSettingsProcessor
     */
    protected function getTypoScriptSettingsProcessorService()
    {
        return $this->services['Dmind\\Cookieman\\DataProcessing\\TypoScriptSettingsProcessor'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\Dmind\Cookieman\DataProcessing\TypoScriptSettingsProcessor::class, ($this->services['TYPO3\\CMS\\Extbase\\Configuration\\ConfigurationManager'] ?? $this->getConfigurationManagerService()));
    }
    ...
    /**
     * Gets the public 'middlewares_decorated_26' shared service.
     *
     * @return \ArrayObject
     */
    protected function getMiddlewaresDecorated26Service()
    {
        $a = ($this->services['service_provider_registry'] ?? $this->get('service_provider_registry', 1));

        return $this->services['middlewares_decorated_26'] = $a->extendService('cookieman', 'middlewares', $this, $a->extendService('vacation_rental', 'middlewares', $this, $a->extendService('bootstrap_package', 'middlewares', $this, $a->extendService('viewpage', 'middlewares', $this, $a->extendService('tstemplate', 'middlewares', $this, $a->extendService('t3editor', 'middlewares', $this, $a->extendService('sys_note', 'middlewares', $this, $a->extendService('seo', 'middlewares', $this, $a->extendService('info', 'middlewares', $this, $a->extendService('felogin', 'middlewares', $this, $a->extendService('extensionmanager', 'middlewares', $this, \TYPO3\CMS\Dashboard\ServiceProvider::configureMiddlewares($this, $a->extendService('beuser', 'middlewares', $this, $a->extendService('belog', 'middlewares', $this, $a->extendService('rte_ckeditor', 'middlewares', $this, $a->extendService('setup', 'middlewares', $this, \TYPO3\CMS\Backend\ServiceProvider::configureMiddlewares($this, $a->extendService('recordlist', 'middlewares', $this, $a->extendService('form', 'middlewares', $this, $a->extendService('impexp', 'middlewares', $this, $a->extendService('filelist', 'middlewares', $this, $a->extendService('fluid_styled_content', 'middlewares', $this, \TYPO3\CMS\Frontend\ServiceProvider::configureMiddlewares($this, $a->extendService('fluid', 'middlewares', $this, \TYPO3\CMS\Extbase\ServiceProvider::configureMiddlewares($this, \TYPO3\CMS\Core\ServiceProvider::configureMiddlewares($this, \TYPO3\CMS\Core\ServiceProvider::getMiddlewares($this)))))))))))))))))))))))))));
    }
